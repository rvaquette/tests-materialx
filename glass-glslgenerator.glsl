...
uniform float iridescence_ior;
uniform float iridescence_thickness;
...
uniform vec3 attenuation_color;
uniform float anisotropy_strength;
uniform float anisotropy_rotation;
...
void main()
{
    ...
    out1 = vec4(mx_srgb_encode(SR_glass_out.color), outAlpha);
